...
<div class="house">
    <div class="house-list" v-if="favorList != ''"  v-for="(item,index) in favorList " :key="index">
      ...
      <div class="tool-bar">
        ...
        <div><img class="love" src="@/assets/img/favor/heart.png" alt="" /></div>
        <div class="message">
          <img src="@/assets/img/favor/xiaoxi.png" alt="" />
