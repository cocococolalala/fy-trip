import {
  ...
  require_crypto,
  require_util
} from "./chunk-GMF3XN2B.js";
import "./chunk-XXIK7VNK.js";
import "./chunk-6PKLSHQ6.js";
import {
  lib
} from "./chunk-FL6QFZHB.js";
import {
  require_node_module,
  require_node_path,
  require_node_url
} from "./chunk-HJ5UHQNG.js";
import {
  postcss_default
} from "./chunk-5RQDA5RF.js";
import "./chunk-H2CV2TVS.js";
import {
  require_fs,
  require_path
} from "./chunk-GXPZP7DX.js";
import {
  __toESM
} from "./chunk-ACCAMVX6.js";

// node_modules/vite/dist/node/chunks/dep-f07a4e2f.js
...
var createImports = (imports, postcss2, mode = "rule") => {
  return Object.keys(imports).map((path2) => {
    ...
    const declarations = Object.keys(aliases).map((key) => postcss2.decl({
      prop: key,
      value: aliases[key],
      raws: { before: "\n  " }
    }));
...
var createExports = (exports, postcss2, mode = "rule") => {
  const declarations = Object.keys(exports).map((key) => postcss2.decl({
    prop: key,
    value: exports[key],
    raws: { before: "\n  " }
  }));
      ...
      case "root": {
        ...
        newNodes = node2.nodes.map((n) => {
          ...
          if (typeof resultingGlobal === "undefined") {
            ...
            throw new Error('Inconsistent rule global/local result in rule "' + node2 + '" (multiple selectors must result in the same mode for the rule)');
          }
...
function getSingleLocalNamesForComposes(root3) {
  return root3.nodes.map((node2) => {
    ...
    if (node2.type !== "pseudo" || node2.value !== ":local" || node2.nodes.length !== 1) {
      throw new Error('composition is only allowed when selector is single :local class name not in "' + root3 + '", "' + node2 + '" is weird');
    }
    node2 = node2.first;
    ...
    prepare(result) {
      ...
      return {
        Once(root3, postcss2) {
          ...
          const exportDeclarations = Object.keys(definitions).map((key) => postcss2.decl({
...
//# sourceMappingURL=dep-f07a4e2f-CEQKZ37T.js.map
